...
8. **Watermark/Sample Notice**: Does the document contain any visible watermark text such as "SAMPLE", "SAMPLE DOCUMENT", "NOT VALID", "FOR TRAINING PURPOSES", or similar overlays? If yes, note the exact text found and flag it — a real official document would never contain such markings.
...
Respond in JSON format:
{
  ...
  "checks": {
    ...
    "noWatermark": { "passed": boolean, "note": "string describing any watermark text found, or 'No watermark detected' if clean" }
  },
